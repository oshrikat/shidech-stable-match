...
@Document(collection = "Matches")
    public class Match {
        ...
        public enum MatchStatus {
            PENDING_RESPONSES, // ממתין לתשובות מהצדדים (המיילים נשלחו)
            ACTIVE_DATING,     // שני הצדדים אישרו - הם יוצאים כרגע!
            REJECTED,          // אחד הצדדים או שניהם סירבו (או שהקשר לא צלח)
            ENGAGED            // מזל טוב! הקשר הסתיים בחתונה/אירוסין
        }
